    ...
    <div class="row">
        <div class="col about-francken">
            <div class="about-francken__j-c-francken">
                <img alt="" src="{{ image("http://beta.professorfrancken.nl/images/prof-jan-carel-francken.png", ['width' => 300, 'height' => 300]) }}" class="prof-c-j-francken-portrait rounded-circle" />
            </div>
