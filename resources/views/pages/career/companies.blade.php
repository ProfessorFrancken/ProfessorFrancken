...
@section('content')
    ...
    'read-more-at' => 'http://www.professorfrancken.nl/wordpress/carriereplaza-2/bedrijfsprofielen/asml/',
    'logo' => 'http://www.professorfrancken.nl/wordpress/media/images/carriereplaza/ASML.png'
    ]])

    @include('pages.career._company-summary', ['company' => [
    'name' => 'De Nederlandsche Bank ',
    'summary' => 'Werken aan vertrouwen. In een professionele werkomgeving die door de actualiteit en de dynamiek van de financiële wereld op een hoog peil staat. Multidisciplinair, in een internationale context. Bij een organisatie met een grote maatschappelijke verantwoordelijkheid - wát we doen, doet er toe. En dat doen we met integriteit, loyaliteit en een groot saamhorigheidsgevoel. Onze succesfactoren. ',
    'read-more-at' => 'http://www.professorfrancken.nl/wordpress/carriere/bedrijfsprofielen/de-nederlandsche-bank/',
    'logo' => 'http://www.professorfrancken.nl/wordpress/media/images/carriereplaza/dnb.png'
    ]])

    @include('pages.career._company-summary', ['company' => [
    'name' => 'DNV GL',
    'summary' => 'Gedreven door onze doelstelling het beschermen van leven, bezit en het milieu (safeguarding life, property and the environment), GL stelt DNV GL organisaties in staat om de veiligheid en duurzaamheid van hun bedrijf te bevorderen. Wij bieden de classificatie en technische zekerheid, samen met software en onafhankelijke deskundige adviesdiensten aan de maritieme, olie en gas, en energie-industrie. Wij bieden ook certificeringsdiensten aan in breed scala van industrieën.',
