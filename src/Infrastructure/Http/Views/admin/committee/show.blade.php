...
@section('content')
  ...
  {!! Form::open(['url' => url('admin/committee', $committee->id), 'method' => 'PUT']) !!}
    ...
    <div class="form-group">
      ...
      <a class="edit-btn btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
      {!! Form::text('email', $committee->email, ['class' => 'edit-input form-control', 'readonly']) !!}
    </div>

    <div class="form-group">
      {!! Form::label('summary', 'Summary:', ['class' => 'control-label']) !!}
      <a class="edit-btn btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
      {!! Form::textarea('summary', $committee->summary, ['class' => 'edit-input form-control', 'rows' => 2, 'readonly' => 'readonly']) !!}
    </div>

    <div class="form-group">
      {!! Form::label('page', 'Commitee page (optional):', ['class' => 'control-label']) !!}
      <a class="edit-btn btn btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
      {!! Form::textarea('page', $committee->markDown, ['class' => 'edit-input form-control', 'readonly' => 'readonly']) !!}
    </div>
