...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <p>
                The Francken Vrij can be found <a href="/about/francken-vrij">here</a>.
            </p>

            <p>
                Francken Vrij is written by both the editorial team and the members. Any member can contribute by writing an article and sending it in to <a href="mailto:franckenvrij@professorfrancken.nl">franckenvrij@professorfrancken.nl</a>.
            </p>
            ...
            <ul>
                <li>Jasper Pluijmers</li>
                <li>Paul Wijnbergen</li>
                <li>Kathinka Frieswijk</li>
                <li>Eva Visser</li>
                <li>Steven Groen</li>
            </ul>
